        ...
        <div className="wrap page-head">
          ...
          <Reveal delay={0.08}>
            <p className="mt-6 max-w-[42ch] text-[clamp(17px,1.55vw,22px)] leading-snug opacity-75">
              Geen schema om aan te houden. {PRODUCT.name} werkt op elk van deze momenten, kies
              wat bij je dag past.
            </p>
          </Reveal>
          <Reveal delay={0.14}>
            ...
            <Reveal>
              <div>
                ...
                <p className="max-w-[40ch] text-[15px] leading-relaxed opacity-75">
                  Er bestaat geen hoeveelheid die voor iedereen klopt. Dit is het startpunt waar
                  de meeste mensen op uitkomen. Pas het aan op wat je ziet.
                </p>
              </div>
            </Reveal>
            <div>
              {HAIRTYPE_ADVICE.map(([type, advice], i) => (
                <Reveal key={type} delay={i * 0.05}>
                  <div className="group grid grid-cols-[auto_1fr] items-baseline gap-[clamp(16px,3vw,40px)] border-t border-papyrus/25 py-5 transition-[border-color] duration-500 ease-folea hover:border-papyrus/70">
                    ...
                    <span className="text-[19px] font-medium transition-transform duration-500 ease-folea group-hover:translate-x-1">
                      {type}
